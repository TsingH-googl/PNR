...
reserve_index = [0, 2,4,6,8,10, 11,13,15,17,19] # 保留哪些bin，下标的形式
x_data_reserve=[]
...
for dataset_name_index in range(len(dataset_name)):
    ...
    excel_path = base_path + dataset_name[dataset_name_index] + '_recall.xls'
    ...
    plt.ylabel("Recall@"+str(topL_array[topL_index]), fontsize=x_y_label_fontsize, color='black')
...
plt.savefig('./figures//' + 'paraSen_recall.png', format='png',
            bbox_inches='tight',
