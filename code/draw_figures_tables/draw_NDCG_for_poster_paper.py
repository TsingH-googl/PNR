...
xls_file_path  = 'C://Users\dell\Desktop//ndcg.xlsx'
...
# 画图
plt.figure(figsize=(10, 3.7)) # figsize=(17, 3)或1
# plt.style.use("ggplot")
legend_fontsize=5.7
...
for i in range(7):
    ...
    plt.xlabel("N"+"\n\n", fontsize=x_y_label_fontsize)
    if i==0:
        plt.ylabel("NDCG@N", fontsize=x_y_label_fontsize)
    # if i==3:
    #     plt.xlabel("ML100K", fontsize=title_fontsize, fontweight=fontweight)
    #
    # plt.grid()
    ax = plt .gca()
...
for i in range(7):
    ...
    if i==0:
        plt.ylabel("NDCG@N", fontsize=x_y_label_fontsize)
    # if i==3:
    #     plt.xlabel("Delicious", fontsize=title_fontsize, fontweight=fontweight)
...
plt.savefig('./figures//' + 'ndcg.pdf', format='pdf', transparent=True,
            bbox_inches='tight',
