...
title_fontsize = 17
fig.text(0.417, 0.85, '(a)', fontsize=title_fontsize, fontweight='semibold')
...
xls_file_path  = 'C://Users\dell\Desktop//table.xlsx'
...
plt.xlim(0.07, 0.11)
my_x_ticks = np.arange(0.07, 0.11, 0.01)
...
# plt.xlim(0.11, 0.201)
# my_x_ticks = np.arange(0.11, 0.201, 0.02)
# plt.xticks(my_x_ticks)
...
plt.savefig('./figures//' + xlabel +'.pdf', format='pdf', transparent=True,
